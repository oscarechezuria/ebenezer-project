...
export default function AboutUs() {
    return (
        <div className="flex items-center flex-col mb-16">
            <h2 className="text-one my-8 text-3xl underline underline-offset-8 font-extrabold">Quienes somos</h2>
            <h3 className="text-center text-2xl p-2 leading-10 font-extrabold my-4">
